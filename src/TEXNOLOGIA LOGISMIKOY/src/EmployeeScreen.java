...
public class EmployeeScreen  extends JFrame implements ActionListener{
	...
	EmployeeScreen(){
			...
			Ticket_res =  new JLabel("Ticket Reservation:");
				Res_del =  new JLabel("Reservation Delete");
					del_movie =  new JLabel("Delete Movie");	
						Welcome_msg =  new JLabel("WELCOME BACK !!!");
							Employye_tool =  new JLabel("----------------------------------EMPLOYEE TOOL----------------------------------");
	   ...
	   panel1.setBackground(Color.white);  					
	    panel1.add(Welcome_msg,panel1.CENTER_ALIGNMENT);
	    	panel1.add(Employye_tool,panel1.BOTTOM_ALIGNMENT);
